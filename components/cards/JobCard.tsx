...
const JobCard = ({ job }: { job: Job }) => {
  ...
  return (
    <section key={job_title} className="background-light900_dark200 light-border shadow-light100_darknone flex flex-col items-start gap-6 rounded-lg border p-6 sm:flex-row sm:p-8">
